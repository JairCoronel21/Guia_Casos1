...
public class Caso17 {
	...
	public static void main(String[] args) {
		...
		System.out.println("---------");
		System.out.println("APROBADOS:.............." + Math.floor(aprobados)+ "%");
		System.out.println("DESAPROBADOS:..........." + Math.floor(desaprobados)+ "%");
		System.out.println("RETIRADOS:.............." + Math.floor(retirados)+ "%");
